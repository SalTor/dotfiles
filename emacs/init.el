...
(custom-set-faces
 ...
 '(org-level-1 ((t (:inherit default :extend nil :foreground "DarkGoldenrod1" :slant normal :weight bold :height 1.75 :width normal :foundry "nil" :family "Lucida Grande"))))
 '(org-level-2 ((t (:inherit default :extend nil :foreground "chocolate1" :slant normal :weight bold :height 1.5 :width normal :foundry "nil" :family "Lucida Grande"))))
 '(org-level-3 ((t (:inherit default :extend nil :foreground "salmon1" :slant normal :weight bold :height 1.25 :width normal :foundry "nil" :family "Lucida Grande"))))
