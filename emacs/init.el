...
(custom-set-faces
 ...
 '(treemacs-directory-face ((t (:inherit dired-directory :height 1))))
 '(treemacs-file-face ((t (:foreground "#ffffff" :height 1))))
 '(treemacs-git-modified-face ((t (:inherit warning :height 1))))
