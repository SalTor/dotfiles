...
#+begin_src emacs-lisp
  ...
  (use-package evil-goggles
    :after evil
    :custom
    (evil-goggles-yank-face ((t (:inherit evil-goggles-default-face :background "LightGreen"))))
    :config
...
#+begin_src emacs-lisp
  ...
  (leader-keys
    "gs" 'magit-status
    "g," '(hydra-smerge/body :which-key "Simple-Merge"))
#+end_src
** Neotree / Treemacs
#+begin_src emacs-lisp
...
#+begin_src emacs-lisp
  ...
  (use-package ts-fold
    ...
    :config
    (global-ts-fold-mode)
    (add-to-list 'ts-fold-range-alist '(tsx-ts-mode
    ...
    (add-to-list 'ts-fold-range-alist '(typescript-ts-mode
                                       (export_clause . ts-fold-range-seq)
                                       (statement_block . ts-fold-range-seq)
                                       (object . ts-fold-range-seq)
                                       (array . ts-fold-range-seq)
...
#+begin_src emacs-lisp
  (use-package lsp-mode
    ...
    (setq lsp-idle-delay 0.25
          lsp-auto-guess-root t ;; Automatically guess the project root using projectile/project.
          lsp-restart 'auto-restart
          lsp-completion-enable t
          lsp-enable-indentation nil
          lsp-enable-symbol-highlighting t
          lsp-log-io t ;; Don't log everything = speed
          lsp-lens-enable nil
  ...
  (with-eval-after-load 'lsp-mode
    ...
    (mapc #'lsp-flycheck-add-mode '(typescript-ts-mode tsx-ts-mode js-mode css-mode vue-html-mode)))
  ...
  (use-package lsp-ui
    ...
    :config
    (evil-define-key 'normal 'lsp-ui-doc-mode [?K] #'sal/lsp-ui-doc-show)
    (evil-define-key 'normal 'lsp-ui-doc-frame-mode [?q] #'sal/lsp-ui-doc-hide)
