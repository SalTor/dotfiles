...
#+begin_src emacs-lisp
  ...
  (custom-theme-set-faces
   'user
   '(line-number ((t (:inherit default :foreground "#7c6f64" :strike-through nil :underline nil :slant normal :weight normal :height 130 :family "Source Code Pro"))))
   '(line-number-current-line ((t (:inherit (hl-line default) :background "#3c3836" :foreground "#fabd2f" :strike-through nil :underline nil :slant normal :weight normal :height 130 :family "Source Code Pro"))))
  )
...
#+begin_src emacs-lisp
  (let* ((variable-tuple (cond ((x-list-fonts "Source Sans Pro") '(:font "Source Sans Pro"))
                               ...
                               ((x-list-fonts "Cantarell")       '(:font "Cantarell"))
                               ((x-family-fonts "Cantarell")     '(:family "Cantarell"))
  ...
  (use-package org
    ...
    (setq org-ellipsis " ▾")
    (set-face-attribute 'org-table nil :font "Source Code Pro" :height 130 :inherit 'fixed-pitch)
    (set-face-attribute 'org-code nil :font "Source Code Pro" :height 130 :inherit 'fixed-pitch)
    (set-face-attribute 'org-block nil :font "Source Code Pro" :height 130 :inherit 'fixed-pitch)
    (set-face-attribute 'org-block-begin-line nil :font "Source Code Pro" :height 130 :inherit '(shadow fixed-pitch))
    (set-face-attribute 'org-block-end-line nil :font "Source Code Pro" :height 130 :inherit '(shadow fixed-pitch))
    :custom
