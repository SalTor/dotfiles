" All borrowed from https://github.com/wincent/
let s:expansion_active = 0

function! saltor#autocomplete#setup_mappings() abort
    ...
    execute 'inoremap <buffer> <silent> ' . g:UltiSnipsJumpForwardTrigger .
                \ ' <C-R>=saltor#autocomplete#expand_or_jump("N")<CR>'
    execute 'snoremap <buffer> <silent> ' . g:UltiSnipsJumpForwardTrigger .
                \ ' <Esc>:call saltor#autocomplete#expand_or_jump("N")<CR>'
    execute 'inoremap <buffer> <silent> ' . g:UltiSnipsJumpBackwardTrigger .
                \ ' <C-R>=saltor#autocomplete#expand_or_jump("P")<CR>'
    execute 'snoremap <buffer> <silent> ' . g:UltiSnipsJumpBackwardTrigger .
                \ ' <Esc>:call saltor#autocomplete#expand_or_jump("P")<CR>'
...
function! saltor#autocomplete#teardown_mappings() abort
...
" Tab" that saltor#autocomplete#expand_or_jump() ends up using.
inoremap <expr> <BS> saltor#autocomplete#smart_bs()

let g:ulti_jump_backwards_res = 0
let g:ulti_jump_forwards_res = 0
let g:ulti_expand_res = 0

function! saltor#autocomplete#expand_or_jump(direction) abort
    ...
    if g:ulti_expand_res == 0
        ...
        if pumvisible()
            ...
            if s:expansion_active
                ...
                if a:direction ==# 'N'
                    return saltor#autocomplete#smart_tab()
                endif
            endif
        endif
    endif
