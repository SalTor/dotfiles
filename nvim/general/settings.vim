...
set lazyredraw wildmenu spelllang=en_us
...
set wrap breakindent breakindentopt=shift:2
let &showbreak='⤷ '

set foldtext=saltor#settings#foldtext() foldlevelstart=50 foldopen-=block
