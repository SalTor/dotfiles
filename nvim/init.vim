...
source $NVIM/keys/coc.vim
source $NVIM/keys/command.vim
source $NVIM/keys/defaults.vim
source $NVIM/keys/insert.vim
source $NVIM/keys/normal.vim
source $NVIM/keys/terminal.vim
