...
export FZF_DEFAULT_OPTS='--bind "esc:abort,?:toggle-preview" --layout=reverse --info=inline --cycle --height=40% --preview-window bottom:25:hidden --preview="bat --theme="zenburn" --color=always --line-range :50 --paging=never --style=grid,numbers,changes,header {}"'
